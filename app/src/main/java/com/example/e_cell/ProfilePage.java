...
public class ProfilePage extends AppCompatActivity {
    ...
    public void openActivity8(View v){
        Intent it8 = new Intent(ProfilePage.this, CovidStats.class);
        startActivity(it8);
    }

    public void openActivity9(View v){
        Intent it9 = new Intent(ProfilePage.this, DashBoard.class);
        startActivity(it9);
    }

    public void openActivity10(View v){
        Intent it10 = new Intent(ProfilePage.this, AdminPage.class);
        startActivity(it10);
    }
